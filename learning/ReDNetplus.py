...
from backbone import resnet, UNet
...
class BaseNet(nn.Module):
    def __init__(self, nclass, backbone='resnet101', aux=False, se_loss=False, dilated=True, norm_layer=None,
                 root='./initmodel',
...
class ReDNetPlus(BaseNet):
    def __init__(self, nclass=N_CLASSES, backbone='resnet101', aux=False, se_loss=False, norm_layer=nn.BatchNorm2d, 
                 **kwargs):
        ...
        self.munet = UNet.MUNet(num_classes=256)
